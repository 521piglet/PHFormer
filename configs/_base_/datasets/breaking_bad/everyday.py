...
_C = CN()
_C.dataset = 'geometry'
_C.data_dir = '/Bill/DataSet/Assembly/data_split'
# _C.data_dir = '/root/autodl-tmp/DataSet/Assembly/data_split'
...
_C.overfit = -1
_C.pre_compute = False  # change this to False after you have pre-processed the dataset
