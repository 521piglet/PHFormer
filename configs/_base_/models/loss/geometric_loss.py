...
_C.trans_loss_w = 1.
_C.rot_pt_cd_loss_w = 10.            # 10.
_C.transform_pt_cd_loss_w = 10.      # 10.
...
_C.rel_trans_loss_w = 1.
_C.rel_rot_loss_w = 0.2
_C.rel_transform_pt_cd_loss_w = 10.
_C.corr_loss_w = 1.
_C.overlap_loss_w = 1.
_C.reconstruction_loss_w = 1.
