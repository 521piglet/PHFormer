...
class DGLModel(BaseModel):
    ...
    def _loss_function(self, data_dict, out_dict={}, optimizer_idx=-1):
        ...
        # np.save('./models/pcs.npy', part_pcs[0].detach().cpu().numpy())
        # np.save('./models/gt_trans.npy', gt_trans[0].detach().cpu().numpy())
        # np.save('./models/gt_rot.npy', gt_rot.convert('rmat').rot[0].detach().cpu().numpy())
        # pdb.set_trace()
